// https://github.com/NiiightmareXD/windows-capture/tree/main
...
use crate::windows_capture::d3d11::{self, create_d3d_device};
use crate::windows_capture::frame::Frame;
use crate::windows_capture::graphics_capture_api::{self, GraphicsCaptureApi, InternalCaptureControl};
use crate::windows_capture::settings::{Settings, TryIntoCaptureItemWithType};
