...
use crate::windows_capture::capture::GraphicsCaptureApiHandler;
use crate::windows_capture::d3d11::{self, SendDirectX, create_direct3d_device};
...
pub enum Error {
    ...
    WindowError(#[from] crate::windows_capture::window::Error),
